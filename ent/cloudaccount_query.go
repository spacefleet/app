...
func (_q *CloudAccountQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *CloudAccountQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *CloudAccountQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *CloudAccountQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *CloudAccountQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *CloudAccountQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(cloudaccount.FieldOrgSlug).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.CloudAccount.Query().
//		Select(cloudaccount.FieldOrgSlug).
//		Scan(ctx, &v)
...
func (_q *CloudAccountQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(cloudaccount.Table, cloudaccount.Columns, sqlgraph.NewFieldSpec(cloudaccount.FieldID, field.TypeUUID))
	_spec.From = _q.sql
